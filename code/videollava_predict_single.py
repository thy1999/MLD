...
videollava_model_path = '/public/home/dzhang/pyProject/hytian/XModel/Video-LLaVA-main/checkpoints/videollava-7b-lora_epoch7'
...
save_file='/public/home/dzhang/pyProject/hytian/XModel/Multi-Agents-Debate-main/data/videollava_predict_youcook2_epoch7.json'
...
with open(test_gold_caps_path,'r',encoding='utf-8') as file:
    ...
    for line in file:
        ...
        #messages=[[{'role':'system','content':s_prompt.replace('##sentence##', old_data['sentence'])},{'role':"user",'content':u_prompt.replace('##sentence##', old_data['sentence'])},{'role':"assistant",'content':'ahh'},{'role':"user",'content':'what?'}]]
        #import pdb;pdb.set_trace()
        cnt=0
        while True:
            try:
                ...
                if cnt>3:
                    ...
                    break
                #import pdb;pdb.set_trace()
                gen=videollava_generate(videollava_tokenizer,
                  videollava_model, 
