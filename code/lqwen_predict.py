...
def evalute(max_lengths,pred_spans, gold_spans, gold_labels):
 ...
 #读取qwen模型结果
qwen_tokenizer = AutoTokenizer.from_pretrained("/public/home/dzhang/pyProject/hytian/YModel/Qwen-VL-master/output_qwen_ptb", trust_remote_code=True)
qwen_model = AutoPeftModelForCausalLM.from_pretrained(
    '/public/home/dzhang/pyProject/hytian/YModel/Qwen-VL-master/output_qwen_ptb', # path to the output directory
    device_map="auto",
...
# save_file='/public/home/dzhang/pyProject/hytian/YModel/Multi-Agents-Debate-main/data/lqwen_predict1_450.json'
...
save_file='/public/home/dzhang/pyProject/hytian/YModel/Multi-Agents-Debate-main/data/lqwen_predict1_450_dev.json'
        ...
        while True:
            try:
                ...
                if cnt>3:
                    ...
                    break
                gen=Qwen_generate(qwen_tokenizer,
                  qwen_model, 
                  image_file,
                  messages,
                  temperature= 0.2,
