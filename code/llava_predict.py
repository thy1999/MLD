...
#读取llava模型结果
disable_torch_init()
model_path="/public/home/dzhang/pyProject/hytian/YModel/LLaVA-main/llava-v1.5-7b_lora_ptb_450"
model_base='/public/home/dzhang/pyProject/hytian/YModel/LLaVA-main/llava-v1.5-7b'

model_name = get_model_name_from_path(model_path) 
#import pdb;pdb.set_trace()
llava_tokenizer, llava_model, llava_image_processor, llava_context_len = load_pretrained_model(model_path=model_path,  model_base=model_base, model_name=model_name, load_8bit=False, load_4bit=False,device='cuda')
...
# save_file='/public/home/dzhang/pyProject/hytian/YModel/Multi-Agents-Debate-main/data/llava_predict1_v1.5_ptb450.json'
...
save_file='/public/home/dzhang/pyProject/hytian/YModel/Multi-Agents-Debate-main/data/llava_predict1_v1.5_ptb450_dev.json'
test_imgs_path='/public/home/dzhang/pyProject/hytian/YModel/MSCOCO/images_list/val2014_imgs_path_list.json'
test_gold_caps_path='/public/home/dzhang/pyProject/hytian/YModel/MSCOCO/mscoco/val_gold_caps.json'


with open(test_imgs_path,'r',encoding='utf-8') as file:
    test_imgs_lst=json.load(file) #图片列表，五个字幕对应一张图
...
with open(test_gold_caps_path,'r',encoding='utf-8') as file:
    ...
    for line in file:
        ...
        line = line.strip()
        items=eval(line)
        caps,spans,labels, pos_tag =items
        old_data={}
        old_data['sentence']=caps
        old_data['label']=labels
        old_data['gold_span']=spans
        img=test_imgs_lst[line_cnt//5]
        image_file=img
       # s_prompt=""
        ...
        #u_prompt="Please use the provided image to help understand the context and structure of the sentence, and then perform constituency parsing on the following sentence: '##sentence##' -->"
        ...
        while True:
            try:
                ...
                if cnt>3:
                    ...
                    break
                gen=Llama_generate(llava_tokenizer,
                            llava_model, 
                ...
                try:
                    llm_pred_tree = Format_output(old_data['sentence'], gen.split('My_result: ')[-1].split('Your_result: ')[-1].split("correction:")[-1].split("correct result")[-1]) 
        ...
        new_data['output_pred'] = llm_pred_tree
        ...
        max_lengths.append(len(caps.split()))
