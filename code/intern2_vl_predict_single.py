...
def evalute(max_lengths,pred_spans, gold_spans, gold_labels):
 ...
 #读取intern模型结果
#path = '/public/home/dzhang/pyProject/hytian/XModel/InternVL-main/output/internvl2-8b/v0-20241124-214949/checkpoint-140-merged'
#path = '/public/home/dzhang/pyProject/hytian/XModel/InternVL-main/output/internvl2-8b/v4-20241220-205556/checkpoint-140-merged'
...
#path ='/public/home/dzhang/pyProject/hytian/XModel/InternVL-main/output/internvl2-8b/v6-20250105-155033/checkpoint-84-merged'
...
save_file='/public/home/dzhang/pyProject/hytian/XModel/Multi-Agents-Debate-main/data/intern2_vl_predict_youcook2_128_256_test.json'
        ...
        while True:
            try:
                ...
                if cnt>3:
                    ...
                    break
                gen=intern2_vl_generate(intern2_vl_tokenizer,intern2_vl_model,image_file,messages,temperature= 0.2,max_new_tokens = 512,)  
                #print(gen)  
               # import pdb;pdb.set_trace()
                try:
